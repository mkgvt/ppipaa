...
--   conversion in place.
*/
ppipaa_errno ppipaa_anonymize_ipv4(ipanonymizer *anonymizer,
                                   unsigned int prefix,
...
--   conversion in place.
*/
ppipaa_errno ppipaa_anonymize_ipv6(ipanonymizer *anonymizer,
                                   unsigned int prefix,
...
-- responsibility.
*/
static ppipaa_errno ppipaa_externalize_plaintext(ipanonymizer *anonymizer,
                                                 FILE *out) {
  // Sanity check
  if (anonymizer == NULL) {
    return PPIPAA_ERROR_NULL;
...
-- responsibility.
*/
static ppipaa_errno ppipaa_externalize_encrypted(ipanonymizer *anonymizer,
                                                 FILE *out,
                                                 char *key, int keylen) {
  // Sanity check
  if (anonymizer == NULL) {
...
-- responsibility.
*/
static ppipaa_errno ppipaa_externalize(ipanonymizer *anonymizer, FILE *out,
                                       char *key, int keylen) {
  if (key == NULL) {
...
-- responsibility.
*/
static ppipaa_errno ppipaa_internalize_plaintext(ipanonymizer *anonymizer,
                                                 FILE *in) {
  // Sanity check
  if (anonymizer == NULL) {
    return PPIPAA_ERROR_NULL;
...
-- responsibility.
*/
static ppipaa_errno ppipaa_internalize_encrypted(ipanonymizer *anonymizer,
                                                 FILE *in,
                                                 char *key, int keylen) {
  // Sanity check
  if (anonymizer == NULL) {
...
-- responsibility.
*/
static ppipaa_errno ppipaa_internalize(ipanonymizer *anonymizer,
...
*/
static ppipaa_errno ppipaa_deinit(ipanonymizer *anonymizer) {
  // Sanity check
  if (anonymizer == NULL) {
    return PPIPAA_ERROR_NULL;
  }
...
*/
ppipaa_errno ppipaa_init(ipanonymizer *anonymizer) {
  // Sanity check
  if (anonymizer == NULL) {
    return PPIPAA_ERROR_NULL;
  }
