...
typedef struct ppipaa_state ipanonymizer;
...
struct ppipaa_state {
  ...
  */
  ppipaa_errno (*init)(ipanonymizer *anonymizer);
  ...
  */
  ppipaa_errno (*deinit)(ipanonymizer *anonymizer);
  ...
  */
  ppipaa_errno (*externalize)(ipanonymizer *anonymizer, FILE *out,
                              char *key, int keylen);
  ...
  --       responsibility.
  */
  ppipaa_errno (*internalize)(ipanonymizer *anonymizer, FILE *in,
                              char *key, int keylen);
  ...
  --   conversion in place.
  */
  ppipaa_errno (*anonymize_ipv4)(ipanonymizer *anonymizer,
                                 unsigned int prefix,
  ...
  --   conversion in place.
  */
  ppipaa_errno (*anonymize_ipv6)(ipanonymizer *anonymizer,
                                 unsigned int prefix,
...
-- NOTE: caller is responsible for managing the storage on the stack or heap.
*/
extern ppipaa_errno ppipaa_init(ipanonymizer *anonymizer);
